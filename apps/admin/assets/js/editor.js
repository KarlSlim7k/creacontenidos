...
import { esc, badge, loadingCard, initialsOf } from './util.js';
...
// Construye un documento HTML autocontenido que imita el render público (apps/web/main.js)
...
export function buildNotaPreviewDoc(d) {
